<div wire:poll class="data-template">
    <div class="req-card-container">
        ...
        @foreach ($allAdmin as $admin)
            @foreach ($admin->reqLiburNasional as $req)
                <div class="req-card">
                    <div class="req-head">
                        ...
                        @else
                            <div class="form-row">
                                <div class="form-field">
                                    ...
                                    <input type="text" value="{{ $req->nama_libur }}" disabled> 
                                </div>
                            </div>
                            <div class="form-row" style="margin: 0; margin-bottom: 8px">
                                <div class="form-field">
                                    <label>Mulai Tanngal</label>
                            ...
                            <div class="form-row">
                                <div class="form-field">
                                    ...
                                    <input type="text" value="{{ $req->pengumuman }}" disabled> 
                                </div>
                            </div>
                        @endif
                    </div>
